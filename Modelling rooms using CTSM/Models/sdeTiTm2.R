sdeTiTm2 <- function(data, yTi,Ph){
  ...
  model = ctsm()
  # Add a system equation and thereby also a state #+a7*bs7+a6*bs6
  model$addSystem(dTi ~  1/Ci*(1/Ria*(Ta-Ti) + 1/Rim*(Tm-Ti) + Ph + (a1*bs1+a2*bs2+a3*bs3+a4*bs4+ a5*bs5+a6*bs6+a7*bs7)*Gv)*dt + exp(p11)*dw1)
