sdeTiTmAv <- function(data, yTi,Ph){
  ...
  model$addSystem(dTi ~  (1/Ri2*yTi2+1/Ci*(1/Ria*(Ta-Ti) + 1/Rim*(Tm-Ti) + Ph + (a7*bs7+a1*bs1+a2*bs2+a3*bs3+a4*bs4+a5*bs5+a6*bs6)*Gv))*dt + exp(p11)*dw1)
  ...
  model$setParameter(a6 = c(init = 0))
