sdeTiTmAv <- function(data, yTi,Ph){
  ...
  model$setParameter(a1 = c(init = 85, lb = 1E-2, ub = 180))
  model$setParameter(a2 = c(init = 6, lb = -10, ub = 180))
  model$setParameter(a3 = c(init = 6, lb = 1E-2, ub = 180))
  model$setParameter(a4 = c(init = 3, lb = -10, ub = 180))
  model$setParameter(a5 = c(init = 3, lb = 1E-2, ub = 180))
  model$setParameter(a6 = c(init = 3, lb = 1E-2, ub = 180))
  model$setParameter(a7 = c(init = 3, lb = 1E-2, ub = 180))
  ##----------------------------------------------------------------    
